...
export default function Doctors() {
  ...
  const filteredDoctors = doctors.filter(doc => {
    ...
    if (activeCategory === 'All') {
      ...
      matchesCategory = specialization.toLowerCase().includes('general') || specialization.toLowerCase().includes('physician');
    } else if (activeCategory === 'Cardiology') {
      matchesCategory = specialization.toLowerCase().includes('cardio');
    } else if (activeCategory === 'Neurology') {
      matchesCategory = specialization.toLowerCase().includes('neuro');
    } else if (activeCategory === 'Dermatology') {
      matchesCategory = specialization.toLowerCase().includes('derma');
    } else if (activeCategory === 'Dental') {
      matchesCategory = specialization.toLowerCase().includes('dent');
    } else if (activeCategory === 'Mental Health') {
      matchesCategory = specialization.toLowerCase().includes('mental') || specialization.toLowerCase().includes('psych');
    } else {
      matchesCategory = specialization.toLowerCase().includes(activeCategory.toLowerCase());
    }

    return (
      (name.toLowerCase().includes(term) || specialization.toLowerCase().includes(term)) &&
      matchesCategory
    );
  });
